...
var exec = exports.exec = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(argv2) {
    var argv, forceBuild, input, inputJson, inputBin, bin, inputFin, config, configJson, bundleDir, output, outputDir, autoOutput, name, ext, sTargets, targets, jsonTargets, different, target, file, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, _target, _file, options, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _target2, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, _target3, f, _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, _target4, _f, tuple, records, stripes, _iteratorNormalCompletion8, _didIteratorError8, _iteratorError8, _iterator8, _step8, _target5, slash, copiedFileCount, _iteratorNormalCompletion9, _didIteratorError9, _iteratorError9, _iterator9, _step9, fileKey, source, dest, sourceStat, destDir, fileStat, _iteratorNormalCompletion10, _didIteratorError10, _iteratorError10, _iterator10, _step10, _target6;
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            argv = (0, _minimist2.default)(argv2, {
              ...
              string: ['_', 'bundledir', 'bundle-dir', 'c', 'config', 'o', 'options', 'output', 'outdir', 'out-dir', 't', 'target', 'targets']
            });
          ...
          case 59:
            ...
            bundleDir = argv.bundledir || argv['bundle-dir'];
          ...
          case 100:
            _context3.prev = 100;
            _context3.t2 = _context3['catch'](96);
          ...
          case 132:
            _context3.prev = 132;
            _context3.t3 = _context3['catch'](117);
          ...
          case 163:
            _context3.prev = 163;
            _context3.t4 = _context3['catch'](147);
          ...
          case 198:
            _context3.prev = 198;
            _context3.t5 = _context3['catch'](179);
          ...
          case 208:
            return _context3.finish(205);

          case 209:
            return _context3.finish(202);
          ...
          case 234:
            _context3.prev = 234;
            _context3.t6 = _context3['catch'](219);
          ...
          case 244:
            return _context3.finish(241);

          case 245:
            return _context3.finish(238);
          ...
          case 246:
            ...
            _log.log.info('Looking through ' + (0, _keys2.default)(records).length + ' sources to copy to ' + bundleDir);
            _context3.next = 251;
            return (0, _fsExtra.remove)(bundleDir);
          ...
          case 251:
            ...
            _context3.prev = 255;
            _iterator9 = (0, _getIterator3.default)((0, _keys2.default)(records));
          ...
          case 257:
            ...
            fileKey = _step9.value;
            source = _path2.default.relative(process.cwd(), records[fileKey].file);
            dest = _path2.default.join(bundleDir, source);
            ...
            return _context3.abrupt('continue', 283);

          case 263:
            _context3.next = 265;
            return (0, _fsExtra.stat)(source);
          ...
          case 265:
            ...
            _log.log.debug('copying ' + source + ' to ' + dest);
            destDir = _path2.default.dirname(dest);
            _context3.next = 271;
            return (0, _fsExtra.mkdirp)(destDir);

          case 271:
            _context3.next = 273;
            return (0, _fsExtra.copy)(source, dest);

          case 273:
            _context3.next = 275;
            return (0, _fsExtra.stat)(dest);

          case 275:
            fileStat = _context3.sent;
            ...
            throw (0, _log.wasReported)('Failed to copy file ' + source + ' to ' + dest);
          ...
          case 281:
            ...
            throw (0, _log.wasReported)('Unhandled source type for ' + source);
          ...
          case 288:
            _context3.prev = 288;
            _context3.t7 = _context3['catch'](255);
          ...
          case 298:
            return _context3.finish(295);

          case 299:
            return _context3.finish(292);

          case 300:
            _log.log.info('Copied ' + copiedFileCount + ' files to ' + bundleDir);
          ...
          case 301:
            ...
            _context3.prev = 304;
            _iterator10 = (0, _getIterator3.default)(targets);
          ...
          case 306:
            ...
            _target6 = _step10.value;
            _context3.next = 310;
            return (0, _fsExtra.mkdirp)(_path2.default.dirname(_target6.output));

          case 310:
            _context3.next = 312;
            return (0, _fsExtra.remove)(_target6.output);
          ...
          case 322:
            _context3.prev = 322;
            _context3.t8 = _context3['catch'](304);
            _didIteratorError10 = true;
            _iteratorError10 = _context3.t8;
          ...
          case 332:
            return _context3.finish(329);

          case 333:
            return _context3.finish(326);
    ...
    }, _callee3, this, [[96, 100, 104, 112], [105,, 107, 111], [117, 132, 136, 144], [137,, 139, 143], [147, 163, 167, 175], [168,, 170, 174], [179, 198, 202, 210], [203,, 205, 209], [219, 234, 238, 246], [239,, 241, 245], [255, 288, 292, 300], [293,, 295, 299], [304, 322, 326, 334], [327,, 329, 333]]);
  }));
